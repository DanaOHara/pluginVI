...
/**
 * @module moodle-atto_mavipp-button
 */

/**
 * Atto text editor mavipp plugin.
 *
 * @namespace M.atto_mavipp
 * @class button
 * @extends M.editor_atto.EditorPlugin
 */

var COMPONENTNAME = 'atto_mavipp';
var FLAVORCONTROL = 'mavipp_flavor';
var LOGNAME = 'atto_mavipp';
...
Y.namespace('M.atto_mavipp').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    initializer: function() {
        ...
        Y.Array.each(twoicons, function(theicon) {
            // Add the mavipp icon/buttons
            this.addButton({
                icon: 'ed/' + theicon,
                iconComponent: 'atto_mavipp',
                buttonName: theicon,
